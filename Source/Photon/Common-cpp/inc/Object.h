...
namespace ExitGames
{
	namespace Common
	{
		...
		protected:
			...
			Object(const void* data, nByte type, nByte customType, unsigned int dimensions, const int* sizes, bool makeCopy);
		...
		private:
			...
			void setSizes(const int* sizes, unsigned int dimensions=1);
			...
			void set(const void* data, nByte type, nByte customType, unsigned int dimensions, const int* sizes, bool makeCopy);
			...
			void setWithoutCleanup(const void* data, nByte type, nByte customType, unsigned int dimensions, const int* sizes, bool makeCopy);
			void setToNULL(void);
			...
			bool compareHelper(const void* pData1, const void* pData2, nByte type, nByte customType, unsigned int dimensions, const int* arraySizes, unsigned int recursionDepth) const;
