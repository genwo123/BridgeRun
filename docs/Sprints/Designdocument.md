...
# 데모 영상
아래 링크를 통해서 BridgeRun 게임의 데모 영상을 확인하실 수 있습니다 :)
<링크칸>
...
| 토템 유형 | 게임플레이 값 | 시각적 구현 | 소유권 표시 |
|------------|----------------|------------------------|------------|
| **일반 토템** | 10점 | 활성화된 맵 테마에 따른 고유 디자인 | 획득한 팀의 색상으로 변경 |
| **골드 토템** | 20점 | 테마 디자인의 금색 강화 버전 | 획득한 팀의 색상으로 변경 |
| **다이아몬드 토템** | 30점 | 테마 디자인의 크리스탈/다이아몬드 강화 버전 | 획득한 팀의 색상으로 변경 |
...
* **전방 리스폰 구역** (개발 계획): 맵 곳곳에 설치, 적이 근처에 없을 때만 활성화  
* **낙사 처리**:  
  * 5초 대기 후 가장 가까운 안전한 리스폰 구역으로 부활  
  * 모든 리스폰 구역이 안전하지 않으면 팀 베이스로 귀환 (개발 계획) 
* **리스폰 전략**: 적 팀의 전방 리스폰 구역 주변을 점령하여 그들의 이동 거리 증가 유도(개발 계획)
