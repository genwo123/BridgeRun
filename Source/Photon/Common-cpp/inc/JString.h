...
namespace ExitGames
{
	namespace Common
	{
		...
		public:
			...
			void setFromUnicodeCharacters(const EG_CHAR* sourceCharacters, unsigned int strLen=UINT_MAX);
			void setFromUTF8Characters(const char* sourceCharacters, unsigned int strSize=UINT_MAX);
			void setFromANSICharacters(const char* sourceCharacters, unsigned int strSize=UINT_MAX);
			void setFromASCIICharacters(const char* sourceCharacters, unsigned int strSize=UINT_MAX);

			unsigned int capacity(void) const;
			EG_CHAR charAt(unsigned int index) const;
			int compareTo(const JString& anotherString) const;
			JString& concat(const JString& str);
