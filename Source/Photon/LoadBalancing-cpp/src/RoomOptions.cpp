...
namespace ExitGames
{
	namespace LoadBalancing
	{
		...
		/**
		   ...
		   @details
		   If a client disconnects or if it leaves a room with the 'willComeBack' flag set to true, it's player becomes inactive first and only gets removed from the room after this timeout.
		...
		/**
		   ...
		   When <a href="https://doc.photonengine.com/en-us/realtime/current/reference/webhooks-faq">Webhooks</a> for the used appID have been been set up for <a href="https://doc.photonengine.com/en-us/realtime/current/tutorials/persistence-guide">room persistence</a>,
