...
namespace ExitGames
{
	namespace Chat
	{
		...
		template<typename Ftype>
		bool Peer::opPublishMessage(const Common::JString& channelName, const Ftype pMessageArray, int arrSize)
		{
		...
		template<typename Ftype>
		bool Peer::opPublishMessage(const Common::JString& channelName, const Ftype pMessageArray, const int* pArrSizes)
		{
		...
		template<typename Ftype>
		bool Peer::opSendPrivateMessage(const Common::JString& userName, const Ftype pMessageArray, int arrSize, bool encrypt)
		{
			COMPILE_TIME_ASSERT2_TRUE_MSG(Common::Helpers::ConfirmAllowed<Ftype>::dimensions==1, ERROR_THIS_OVERLOAD_IS_ONLY_FOR_1D_ARRAYS);
		...
		template<typename Ftype>
		bool Peer::opSendPrivateMessage(const Common::JString& userName, const Ftype pMessageArray, const int* pArrSizes, bool encrypt)
		{
			COMPILE_TIME_ASSERT2_TRUE_MSG((Common::Helpers::ConfirmAllowed<Ftype>::dimensions>1), ERROR_THIS_OVERLOAD_IS_ONLY_FOR_MULTIDIMENSIONAL_ARRAYS);
		...
		template<typename Ftype>
		bool Peer::opSetOnlineStatus(int status, const Ftype pMessageArray, int arrSize)
		{
			COMPILE_TIME_ASSERT2_TRUE_MSG(Common::Helpers::ConfirmAllowed<Ftype>::dimensions==1, ERROR_THIS_OVERLOAD_IS_ONLY_FOR_1D_ARRAYS);
		...
		template<typename Ftype>
		bool Peer::opSetOnlineStatus(int status, const Ftype pMessageArray, const int* pArrSizes)
		{
			COMPILE_TIME_ASSERT2_TRUE_MSG((Common::Helpers::ConfirmAllowed<Ftype>::dimensions>1), ERROR_THIS_OVERLOAD_IS_ONLY_FOR_MULTIDIMENSIONAL_ARRAYS);
