...
namespace ExitGames
{
	namespace LoadBalancing
	{
		...
		private:
			...
			Photon::OperationRequestParameters enterRoomImplementation(const RoomOptions* pOptions, const Common::Hashtable& customLocalPlayerProperties, const Common::JVector<Common::JString>& expectedUsers, bool usePropertiesInsteadOfRoomProperties);
