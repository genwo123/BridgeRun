...
namespace ExitGames
{
	namespace Chat
	{
		...
		public:
			...
			virtual bool connect(const AuthenticationValues& authenticationValues=AuthenticationValues(), const Common::JString& nameServerAddress=M_NAMESERVER, bool useBackgroundSendReceiveThread=true);
			...
			template<typename Ftype> bool opPublishMessage(const Common::JString& channelName, const Ftype pMessageArray, int arrSize);
			template<typename Ftype> bool opPublishMessage(const Common::JString& channelName, const Ftype pMessageArray, const int* pArrSizes);
			template<typename Ftype> bool opSendPrivateMessage(const Common::JString& userName, const Ftype& message, bool encrypt=false);
			template<typename Ftype> bool opSendPrivateMessage(const Common::JString& userName, const Ftype pMessageArray, int arrSize, bool encrypt=false);
			template<typename Ftype> bool opSendPrivateMessage(const Common::JString& userName, const Ftype pMessageArray, const int* pArrSizes, bool encrypt=false);
			virtual bool opSetOnlineStatus(int status);
			template<typename Ftype> bool opSetOnlineStatus(int status, const Ftype& message);
			template<typename Ftype> bool opSetOnlineStatus(int status, const Ftype pMessageArray, int arrSize);
			template<typename Ftype> bool opSetOnlineStatus(int status, const Ftype pMessageArray, const int* pArrSizes);
		...
		template<typename Ftype>
		bool Client::opPublishMessage(const Common::JString& channelName, const Ftype pMessageArray, int arrSize)
		{
		...
		template<typename Ftype>
		bool Client::opPublishMessage(const Common::JString& channelName, const Ftype pMessageArray, const int* pArrSizes)
		{
		...
		template<typename Ftype>
		bool Client::opSendPrivateMessage(const Common::JString& userName, const Ftype pMessageArray, int arrSize, bool encrypt)
		{
			COMPILE_TIME_ASSERT2_TRUE_MSG(Common::Helpers::ConfirmAllowed<Ftype>::dimensions==1, ERROR_THIS_OVERLOAD_IS_ONLY_FOR_1D_ARRAYS);
		...
		template<typename Ftype>
		bool Client::opSendPrivateMessage(const Common::JString& userName, const Ftype pMessageArray, const int* pArrSizes, bool encrypt)
		{
			COMPILE_TIME_ASSERT2_TRUE_MSG((Common::Helpers::ConfirmAllowed<Ftype>::dimensions>1), ERROR_THIS_OVERLOAD_IS_ONLY_FOR_MULTIDIMENSIONAL_ARRAYS);
		...
		template<typename Ftype>
		bool Client::opSetOnlineStatus(int status, const Ftype pMessageArray, int arrSize)
		{
			COMPILE_TIME_ASSERT2_TRUE_MSG(Common::Helpers::ConfirmAllowed<Ftype>::dimensions==1, ERROR_THIS_OVERLOAD_IS_ONLY_FOR_1D_ARRAYS);
		...
		template<typename Ftype>
		bool Client::opSetOnlineStatus(int status, const Ftype pMessageArray, const int* pArrSizes)
		{
			COMPILE_TIME_ASSERT2_TRUE_MSG((Common::Helpers::ConfirmAllowed<Ftype>::dimensions>1), ERROR_THIS_OVERLOAD_IS_ONLY_FOR_MULTIDIMENSIONAL_ARRAYS);
